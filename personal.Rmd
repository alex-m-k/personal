...
Alex studies worker involvement in the future of work. With the development of new technologies and an ever-changing business environment, firms are faced with numerous opportunities to rearrange work and implement new practices and policies. Empowering workers by including them in decisions surrounding these changes offers both opportunity and challenge. 

At present, Alex is studying involvement in decisions that pertain to the timing, tools, and technologies used to arrange and perform work. This research takes place inside warehouses, which are part of a rapidly evolving sector of the U.S. economy. A setting replete with contrasts, warehouses are employing more and more people as e-commerce grows yet are also sites where concerns about job quality are primary and innovation in robotics is proceeding apace.

His current projects include investigations into:

- Variation in management approaches to work scheduling and their workforce implications
- Temporal precarity, or how schedules differentially impact different groups of workers' well-being and turnover
...
Riordan, C. A., & Kowalski, A. M. (2020). [From bread and roses to \#MeToo: Multiplicity, distance, and the changing dynamics of conflict in IR theory](https://doi.org/10.1177%2F0019793920970868). Forthcoming at *ILR Review*.
<details> 
